...
public const int MESSAGESIZE	=128;
public const int MESSAGELEN 	=265;

public const int CT_PLR_GREEN	=	1;
public const int CT_PLR_YELLOW	=2;
public const int CT_PLR_RED		=3;
public const int CT_PLR_BLUE	=	4;
public const int CT_PLR_ALL		=5;

public const int CT_KEY_GREEN	=	'g';
public const int CT_KEY_YELLOW	='y';
public const int CT_KEY_RED		='r';
public const int CT_KEY_BLUE	=	'b';
public const int CT_KEY_ALL		='t';
public const int CT_ESCAPE		=	6;

// Public data

public static bool chatmodeon;

// Private data

static public int head;
static public int tail;
static public byte[] ChatQueue = new byte[QUEUESIZE];
static public int[] chat_dest = new int[DoomDef.MAXPLAYERS];
static public string[] chat_msg = new string[DoomDef.MAXPLAYERS];
static public string[] plr_lastmsg = new string[DoomDef.MAXPLAYERS];
static public int[] msgptr = new int[DoomDef.MAXPLAYERS];
static public int[] msglen = new int[DoomDef.MAXPLAYERS];

static public bool cheated;
static int FontABaseLump;
public static string[] CT_FromPlrText = new string[DoomDef.MAXPLAYERS]
{
	"GREEN:  ",
	"YELLOW:  ",
	"RED:  ",
	"BLUE:  "
		...
		public static m_misc.var_string[] chat_macros = new m_misc.var_string[10] {
			new m_misc.var_string(),
			new m_misc.var_string(),
			new m_misc.var_string(),
			new m_misc.var_string(),
			new m_misc.var_string(),
