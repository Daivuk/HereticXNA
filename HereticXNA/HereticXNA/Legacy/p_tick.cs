...
*/
		...
		public static DoomDef.thinker_t thinkercap = new DoomDef.thinker_t();	// both the head and tail of the thinker list
		...
		*/
		...
		public static void P_AddThinker(DoomDef.thinker_t thinker)
		{
		...
		*/
		...
		public static void P_RemoveThinker(DoomDef.thinker_t thinker)
		{
			if (thinker.function != null)
			{
				DoomDef.mobj_t mo = thinker.function.obj as DoomDef.mobj_t;
				if (mo != null) mo.Dispose();
			}
...
*/
		...
		{
			DoomDef.thinker_t currentthinker;
			...
			while (currentthinker != thinkercap)
			{
				...
				{
					if (currentthinker.function != null)
						currentthinker.function.function(currentthinker.function.obj);
				}
		...
		public static void P_Ticker()
		{
			...
			for (i = 0; i < DoomDef.MAXPLAYERS; i++)
			{
				...
				{
					p_user.P_PlayerThink(g_game.players[i]);
				}
			}
			if (p_tick.TimerGame != 0)
			{
				if ((--p_tick.TimerGame) == 0)
				{
					//G_ExitLevel();
